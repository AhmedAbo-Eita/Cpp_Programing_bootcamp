...
// In this exercise, you will write a program that uses the assignment operator = to change the value of an initialized 
//variable as well as assign the value of one variable to another. 
 ...
 * @brief      Main function
 *
 * @details    This program uses the assignment operator to change the value of an initialized 
 *             variable as well as assign the value of one variable to another.
 *
 * @return     0
 **/
